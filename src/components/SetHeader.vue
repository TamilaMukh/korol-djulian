    ...
    <div class="flex">
      ...
      <div class="font-medium hidden lg:block">
        <div class="flex items-center justify-between">
            <p>Доставка пиццы</p>
            <form class="ml-1" action="">
              <select class="text-main font-medium w-auto" id="del-city" name="del-city" @change="changeCity()">          
...
export default {
  ...
  data() {
    return {
      ...
      deliveryCity: localStorage.getItem('deliveryCity'),
      selectedCity: localStorage.getItem('delCityID'),
      form: {
        login: null,
        password: null
      },
  ...
  async mounted() {
    ...
    this.users = res.data
    if (localStorage.getItem('deliveryCity') === null ) {   
      this.changeCity()     
    }
    document.getElementById('del-city').options[this.selectedCity].selected = true    
  },
  async created() {
  ...
  methods: {
    ...
    changeCity() {
      let select = document.getElementById('del-city')
      let selText = select.options[select.selectedIndex].text
      localStorage.setItem('deliveryCity', selText)
      this.deliveryCity = localStorage.getItem('deliveryCity')
      localStorage.setItem('delCityID', select.selectedIndex)
      this.selectedCity = localStorage.getItem('delCityID')     
    }
  }
}
</script>